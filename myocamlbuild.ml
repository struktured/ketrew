(* OASIS_START *)
(* DO NOT EDIT (digest: 7aa05e55a56d3e2af7f543591ac56538) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("ketrew_data", ["gen"], []);
          ("ketrew_pure", ["src/lib/pure"], []);
          ("ketrew", ["src/lib"], []);
          ("ketrew_dummy_plugin_test_lib", ["src/test"], [])
       ];
     lib_c = [];
     flags = [];
     includes =
      ...
      | After_rules     ->
        if has_coverage () then
          begin
            ...
            (* flag ["link"; "native"] (S [A"-I"; A (bsdir ""); A"bisect.cmx"]); *)
          end
        else
          ()
      | _ -> ()
